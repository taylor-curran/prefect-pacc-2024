...
2. Define your trigger:
    ...
    Add a tag that will filter out other people's flow runs, ideally you've tagged you deployment with your name, like in this example, I put `taylor`. Or you can select a specific flow name. Do NOT put `pacc` since you will get a notification from everyone else doing the PACC course!
